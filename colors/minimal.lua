...
if vim.o.background == "dark" then
  ...
  local control_structure_fg = special.keyword
  ...
  local menu_border = { fg = palette.gray4, bg = palette.none }
  local todo_colors = {
    FIX = error,
    TODO = info,
    HACK = warn,
  ...
  theme = {
    ...
    Conditional                                = { fg = control_structure_fg },
    Repeat                                     = { fg = control_structure_fg },
    Label                                      = { fg = def_fg },
    Keyword                                    = { fg = ansi.white },
    Exception                                  = { fg = control_structure_fg },
    ...
    TSKeywordReturn                            = { fg = warn },
    TSKeywordCoroutine                         = { fg = control_structure_fg },
    ...
    TSRepeat                                   = { fg = control_structure_fg },
    ...
    ["@keyword"]                               = { fg = ansi.white },
    ["@keyword.conditional"]                   = { fg = control_structure_fg },
    ["@keyword.conditional.ternary"]           = { fg = control_structure_fg },
    ["@keyword.coroutine"]                     = { fg = control_structure_fg },
    ["@keyword.exception"]                     = { fg = control_structure_fg },
    ["@keyword.function"]                      = { fg = ansi.white },
    ["@keyword.operator"]                      = { fg = punct_fg },
    ["@keyword.repeat"]                        = { fg = control_structure_fg },
    ["@keyword.return"]                        = { fg = warn },
    ["@label"]                                 = { fg = ansi.white },
    ...
    ["@MinimalControlStructure"]               = { fg = control_structure_fg },
    ["@MinimalControlTransfer"]                = { fg = warn },
  ...
  local blink_menu = transparent_opt and { bg = bg, fg = fg } or { link = "Pmenu" }
  local blink_menu_border = { fg = palette.gray4, bg = palette.none }
  local todo_colors = {
    FIX = error,
    TODO = info,
    HACK = warn,
