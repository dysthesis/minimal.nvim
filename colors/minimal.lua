...
if vim.o.background == "dark" then
  ...
  theme = {
    ...
    ["@keyword"]                               = { fg = ansi.white },
    ["@keyword.conditional"]                   = { fg = warn },
    ["@keyword.conditional.ternary"]           = { fg = warn },
    ["@keyword.coroutine"]                     = { fg = warn },
    ["@keyword.exception"]                     = { fg = warn },
    ["@keyword.function"]                      = { fg = ansi.white },
    ["@keyword.operator"]                      = { fg = punct_fg },
    ["@keyword.repeat"]                        = { fg = warn },
