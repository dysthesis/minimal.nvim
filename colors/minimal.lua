...
if vim.o.background == "dark" then
  ...
  local control_structure = { fg = control_structure_fg, bold = true }
  ...
  theme = {
    ...
    Conditional                                = control_structure,
    Repeat                                     = control_structure,
    Label                                      = { fg = def_fg },
    Keyword                                    = { fg = ansi.white },
    Exception                                  = control_structure,
    ...
    TSKeywordCoroutine                         = control_structure,
    ...
    ["@keyword"]                               = { fg = ansi.white },
    ["@keyword.conditional"]                   = control_structure,
    ["@keyword.conditional.ternary"]           = control_structure,
    ["@keyword.coroutine"]                     = control_structure,
    ["@keyword.exception"]                     = control_structure,
    ["@keyword.function"]                      = { fg = ansi.white },
    ["@keyword.operator"]                      = { fg = punct_fg },
    ["@keyword.repeat"]                        = control_structure,
    ...
    ["@MinimalControlStructure"]               = control_structure,
